...
class RemoveVideoBackground:
    def __init__(self) -> None:
        self.unprocessed_frames_folder = 'temp/frames'
        self.processed_frames_folder = 'temp/processed'
        self.processed_frames_with_background_folder = 'temp/processed_with_background'
        self.video_folder = 'temp/video'
    ...
    def _extract_frames_from_video(self, video: UploadFile) -> int:
        ...
        video_path = os.path.join(self.unprocessed_frames_folder, video.filename)
        ...
        for frame_index in range(total_frames):
            ...
            frame_path = os.path.join(self.unprocessed_frames_folder, frame_filename)
